...
namespace NppPluginNET
{
	public class Settings
	{
		...
		public static void LoadConfigs()
		{
			...
			PluginBase.TRACE(string.Format("UseTagFile={0},SortTags={1},CaseSensitiveLanguageMaps={2},ShowIcons={3}," +
			    "FlatView={4},KeepTypesGrouped={5},ShowInvalidSources={6},SearchInSession={7},SessionMode={8}," +
			    "FoldLevel={9},BackColor={10},ShowToolTips={11},ShowGtdToolTips={12},CookieHistoryList={13}",
			    Configs.UseTagFile, Configs.SortTags, Configs.CaseSensitiveLanguageMaps, Configs.ShowIcons,
			    Configs.FlatView, Configs.KeepTypesGrouped, Configs.ShowInvalidSources, Configs.SearchInSession,
			    Configs.SessionMode, Configs.FoldLevel, Configs.BackColor, Configs.ShowToolTips, Configs.ShowGtdToolTips,
